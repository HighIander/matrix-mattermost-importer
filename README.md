...
0. Download all files from this repository into a directory on your computer, e.g. to [downloads/matrix-mattermost-importer]. You can download a zip file and extract it on your computer from the latest release here: https://github.com/HighIander/matrix-mattermost-importer/releases
